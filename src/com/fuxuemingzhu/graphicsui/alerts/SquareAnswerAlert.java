/**
 * <p>Title: SquareAnswerAlert.java</p>
 * <p>Description: </p>
 * 
 * @author caifugui
 *
 ...
 * @date 2014年12月21日 下午2:45:43
 */
public class SquareAnswerAlert extends JFrame {
	 ...
	 * </p>
	 */
	public SquareAnswerAlert(float r) {
		SquareAnswerAlert.r = r;
		square = new Square(r);
		pnl_mian = new JPanel();
		lbl_help = new JLabel();
	...
	public void userInit() {
		...
		this.lbl_r.setText("正方形的边长为:");
		this.lbl_lenth.setText("正方形的周长为:");
		this.lbl_size.setText("正方形的面积为:");
		...
		this.txt_r.setText(square.getA() + "");
		this.txt_lenth.setBounds(130, 80, 200, 20);
		this.txt_lenth.setText(square.calculateLenth() + "");
		this.txt_size.setBounds(130, 110, 200, 20);
		this.txt_size.setText(square.calculateSize() + "");
